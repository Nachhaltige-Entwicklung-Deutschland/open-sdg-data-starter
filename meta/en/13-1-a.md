...
Greenhouse gases = carbon dioxide (CO<sub>2</sub>), methane (CH<sub>4</sub>), laughing gas (N<sub></sub>O), sulphur hexaflouride (SF<sub>6</sub>), nitrogen triflouride (NF<sub>3</sub>), hydroflourocarbons (HFC) and perflourocarbons (PFC).                    
