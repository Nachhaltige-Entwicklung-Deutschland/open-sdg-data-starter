...
data_keyword:                    
data_footnote: 2017 provisional near real time forecast. Greenhouse gases = carbon dioxide (CO2), methane (CH4), laughing gas (N2O), sulphur hexaflouride (SF6), nitrogen triflouride (NF3), hydroflourocarbons (HFC) and perflourocarbons (PFC)                   
