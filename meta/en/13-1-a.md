...
data_keyword:                    
data_footnote: Greenhouse gases (Germany) = carbon dioxide (CO&sub2;), methane (CH&sub4;), laughing gas (N&sub2;O), sulphur hexaflouride (SF&sub6;), nitrogen triflouride (NF&sub3;), hydroflourocarbons (HFC) and perflourocarbons (PFC);  Greenhouse gases (Federal states) = carbon dioxide (CO&sub2;), methane (CH&sub4;), laughing gas (N&sub2;O)                   
