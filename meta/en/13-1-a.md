...
data_keywords:    
data_footnote: Projected figures for 2019; Greenhouse gases = carbon dioxide (CO<sub>2</sub>), methane (CH<sub>4</sub>), nitrous oxide (N<sub>2</sub>O), sulphur hexafluoride (SF<sub>6</sub>), nitrogen trifluoride (NF<sub>3</sub>), hydrofluorocarbons (HFCs) and perfluorocarbons (PFCs)    
