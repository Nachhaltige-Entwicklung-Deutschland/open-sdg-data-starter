...
data_keyword:                    
data_footnote: Data on organic farming from the Federal Statistical Office are only collected every three years and the intermediate years from 2012 onwards are estimated. This method is currently not transferable to the federal states, so the results at the federal state level are only available for the years surveyed.                   
