...
source_url_text_2: Population by educational attainment level (tertiary education only) - <abbr title="European Statistical Office">Eurostat</abbr> table [edat_lfs_9912]
