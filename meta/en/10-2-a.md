...
data_keywords:    
data_footnote: Pensions not included in social benefits.    Data for the EU with the respective member states in the reporting year (until 2019 EU-28 from 2020 EU-27).  Due to methodological changes, the results from 2018 are only comparable with previous years to a limited extent.   2021 provisional data.    
