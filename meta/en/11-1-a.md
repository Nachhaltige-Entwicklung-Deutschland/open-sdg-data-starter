...
source_organisation_logo_2: <a href="https://www.lanuv.nrw.de/liki/index.php"><img src="https://g205sdgs.github.io/sdg-indicators/public/LogosEn/liki.png" alt="Logo Länderinitiative Kernindikatoren (LIKI)" title="Click here to visit the homepage of the organization"></a>
...
data_keyword:                    
data_footnote: "The data basis for evaluations of settlement and transport areas is the official land survey. From the 2016 reporting year onwards, this will be based on the Official Real Estate Cadastre Information System (ALKIS). This will affect comparisons with previous years and make it more difficult to calculate changes. The settlement and transport area determined after the conversion contains largely the same types of use as before"                   
