...
data_keywords:    
data_footnote: Sulphur dioxide (SO<sub>2</sub>), nitrogen oxides (NO<sub>x</sub>), non-methane volatile organic compounds (NMVOCs) and particulate matter (PM<sub>2.5</sub>), average index of measured values.    
