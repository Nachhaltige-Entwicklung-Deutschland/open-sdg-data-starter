...
#Metadata    
national_indicator_available: <small>(Text currently only available in German) </small>Straftaten    
...
indicator_name: <small>(Text currently only available in German) </small>Straftaten    
section: Crime    
