...
dns_indicator_definition: Der Indikator misst in Prozent den Anteil der ausgezahlten Mittel an den Gesamtausgaben für Ernährungssicherung, mit dem die Anwendung relevanter internationaler Normen und Empfehlungen zur Verwirklichung des Rechts auf Nahrung (definiert nach dem Global Strategic Framework des Ausschusses für die Welternährungssicherheit der Vereinten Nationen (Committee on World Food Security, <abbr title="Ausschuss für die Welternährungssicherheit der Vereinten Nationen (Committee on World Food Security)">CFS</abbr>) unterstützt wird.    
...
weather_indicator_1_target: Angemessene Steigerung des Anteils der ausgezahlten Mittel für die Anwendung von Leitlinien und Empfehlungen des <abbr title="Vereinte Nationen (United Nations)">VN</abbr>-Welternährungsausschusses (<abbr title="Ausschuss für die Welternährungssicherheit der Vereinten Nationen (Committee on World Food Security)">CFS</abbr>) an den Gesamtausgaben für Ernährungssicherung in % bis 2030
