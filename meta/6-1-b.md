...
data_show_map: true                   
data_keyword: 6-1-b,6.1.b,6.1.b                   
data_start_values:
 - a) time series
 - b) target
 - a) germany (total)                   
data_footnote: "Basis: EUA-Messnetz: Schwellenwert 50 Milligramm Nitrat pro Liter im Jahresmittel; Keine Daten für die Statdtstaaten vorhanden"                   

computation_units: Anteil der Messstellen, an denen der Schwellenwert eingehalten wird, in&nbsp;%                   
copyright: '&copy; Statistisches Bundesamt (Destatis), 2020'                   

graph_title: Nitrat im Grundwasser <br> <small>Anteilder Messstellen, an denen der Schwellenwert eingehalten wird</small>                
graph_type: line                   
graph_min_value:                    
graph_max_value:                    
stackedBar:                    
