...
data_start_values: 
 ...
 - b) target (max)
 - a) total
 - c) students from ldcs
 - a) students from other developing and emerging countries
 - d) researchers from ldcs
 - b) researchers from other developing and emerging countries                   
