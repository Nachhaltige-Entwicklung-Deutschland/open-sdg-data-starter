...
data_start_values: 
 ...
 - b) target (max)
 - a) germany (total)                   
data_footnote: Treibhausgase (Deutschland) = Kohlendioxid (CO&sub2;), Methan (CH&sub4;), Lachgas (N&sub2;O), Schwefelhexafluorid (SF&sub6;), Stickstofftrifluorid (NF&sub3;), teilhalogenierte Fluorkohlenwasserstoffe (H-FKW/HFC) und perfluorierte Kohlenwasserstoffe (FKW/PFC);  Treibhausgase (Bundesländer) = Kohlendioxid (CO&sub2;), Methan (CH&sub4;); Lachgas (N&sub2;O)                   
