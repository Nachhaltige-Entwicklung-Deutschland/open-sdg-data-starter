...
<div>
  <div class="my-header">
    <label class="default">b) <abbr title="Korruptionswahrnehmungsindex (Corruption Perception Index)">CPI</abbr>  Partnerländer: Verbesserung bis 2030
      <a href="www.dns-indikatoren.de/status"><img src="https://g205sdgs.github.io/sdg-indicators/public/Wettersymbole/Sonne.png" title="Sowohl der Durchschnittswert als auch die vorangegangene jährliche Veränderung deuteten in 2021 in die richtige Richtung." alt="Wettersymbol: Sonne"/>
      </a>
    </label>
  </div>
</div>
